    ...
    <section className="mt-16 px-4 py-4 md:mt-0 md:px-8">
      ...
      <main className="mt-5 font-sans-jarkata">
        ...
        <div className="mt-8 flex flex-col gap-4">
          <Event image="/images/eventImage.png" />
          <Event image="/images/eventImage1.png" />
        </div>
      </main>
    </section>
  );
...
function Event({ image }: { image: string }) {
  return (
    <article className="hidden h-[116px] w-full items-center justify-between gap-4 rounded-lg border-l-[10px] border-l-red-secondary bg-[#F5F5F5] md:flex">
      <div className="flex flex-col gap-6 p-4 md:flex-row md:items-center md:gap-4">
      ...
      <div className="flex h-full items-center self-end px-4">
        <div className="flex h-full flex-col items-center justify-center gap-2 border-x-[0.1px] border-gray px-4 text-xs">
