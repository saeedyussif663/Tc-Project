    ...
    <header className="flex w-full items-center px-3 py-4 md:px-8">
      ...
      <div className="relative mx-auto hidden w-[500px] items-center gap-4 md:flex">
        <input
          ...
          className="w-full rounded-2xl bg-[#F2F2F2] px-12 py-2 font-open-sans text-[#A19B9B]"
        />
        <ListFilter className="cursor-pointer text-[#A19B9B]" size={30} />
        <SearchIcon
          className="absolute bottom-[10px] left-3 cursor-pointer text-[#A19B9B]"
          size={20}
        />
      </div>
      <div className="hidden gap-8 text-[#A19B9B] md:flex">
      ...
      <Sheet>
        <SheetTrigger className="ml-auto md:hidden">
          <Menu size={26} className="text-[#A19B9B]" />
        </SheetTrigger>
        <SheetContent className="flex flex-col gap-6">
          ...
          <div className="flex gap-8 text-[#A19B9B]">
